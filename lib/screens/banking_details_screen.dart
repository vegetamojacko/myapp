...
class _BankingDetailsScreenState extends State<BankingDetailsScreen> {
  ...
  void initState() {
    ...
    _accountNumberController = TextEditingController(text: bankingInfo?.accountNumber ?? '');
    _accountHolderController = TextEditingController(text: bankingInfo?.accountHolder ?? '');
  }
